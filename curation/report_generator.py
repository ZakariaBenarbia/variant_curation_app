...
<section>
  ...
  <div class="filters">
    ...
    <div class="filter-group" style="display:flex;align-items:flex-end;gap:.75rem;flex-wrap:wrap">
      <button class="btn" id="btn-clear">Clear Filters</button>
      <button class="btn btn-excel" id="btn-excel" title="Download visible rows as Excel">⬇ Excel</button>
